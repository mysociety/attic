 ...
 *
 * $Id: search.php,v 1.4 2010-09-23 15:22:35 matthew Exp $
 *
 */
...
function search($search) {
    ...
    if ($is_postcode || $is_partial_postcode)  {
        ...
        $success = 1;
        $location = json_decode(file_get_contents('http://mapit.mysociety.org/postcode/'
            . ($is_partial_postcode ? 'partial/' : '') . rawurlencode($search)), true);
