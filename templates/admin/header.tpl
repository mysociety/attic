    ...
    <div id="divPage">
        <div id="divHeader">
            ...
            <ul id="ulMenu" class="inline">
                <li {if $menu_item =="home"}class="selected"{/if}><a href="{$admin_server}/">Home</a></li>                                     
                <li {if $menu_item =="edit"}class="selected"{/if}><a href="{$admin_server}/searchgroups.php">Manage groups</a></li>                
