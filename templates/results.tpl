{include file="../templates/header.tpl"}
    ...
    <div id="divMeta">
        ...
        groups on this page <a href="http://maps.google.com/maps?f=q&hl=en&q={$rss_link|escape:url}&layer=&ie=UTF8&z=13&om=1">on a map</a>. You can permanently link to this page <a href="{$current_url}">here</a>.
    </div>
